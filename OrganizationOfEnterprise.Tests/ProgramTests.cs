...
namespace OrganizationOfEnterprise.Tests
{
    public class ProgramTests
    {
        ...
        public async  Task TestCase1()
        {
            ...
            t0.ToRecruitEmployee(new Employee { Name = "Name1", Surname = "Surname1", LastName = "LastName1",Sex = HumanSex.Male}, PositionSystem.Director);
            t0.ToRecruitEmployee(new Employee { Name = "Name2", Surname = "Surname2", LastName = "LastName2", Sex = HumanSex.Undefined }, PositionSystem.AssistantManager);
