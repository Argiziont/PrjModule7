 ...
 namespace PrjModule7
{
    internal static class Program
    {
        private static async Task Main()
        {
            ...
            t0.ToRecruitEmployee(new Employee{Name = "Name1", Surname = "Surname1",LastName = "LastName1"},PositionSystem.Director);
            t0.ToRecruitEmployee(new Employee { Name = "Name2", Surname = "Surname2", LastName = "LastName2" }, PositionSystem.AssistantManager);
